...
export const constructNewPayload = (
    receivedPayload: ReceivedWebhookPayload,
    txHash: string
) => {
    return {
        ...receivedPayload,
        data: { ...receivedPayload.data, txHash }
    } as SentWebhookPayload
}
...
export const sendUpdateToCallback = async (
    data: SentWebhookPayload,
    callbackUrl: string,
